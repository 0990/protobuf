...
const (
	netrpcPackage    = protogen.GoImportPath("net/rpc")
)
...
func GenerateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.QualifiedGoIdent(netrpcPackage.Ident("rpc"))
	for _, service := range file.Services {
		genServiceCode(g, service)
	}
}

func genServiceCode(g *protogen.GeneratedFile,service *protogen.Service){
